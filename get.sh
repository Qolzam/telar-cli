...
# Copyright Amirhossein Movahedi @Qolzam
# Adapted from https://github.com/openfaas/faas-cli (https://cli.openfaas.com)
...
export ALIAS_NAME="telar"
export OWNER="Qolzam"
export REPO="telar-cli"
