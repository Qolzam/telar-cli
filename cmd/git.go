...
func cloneTSUI(rootDir, githubUsername string) error {
	...
	if exist == true {
		log.Info("Telar social user interface repository exist. ", path)
		return nil
	}
...
func cloneTSServerless(rootDir, githubUsername string) error {
	...
	if exist == true {
		log.Info("Telar social serverless repository exist. ", path)
		return nil
	}
...
func cloneTelarWeb(rootDir, githubUsername string) error {
	...
	if exist == true {
		log.Info("Telar web repository exist. ", path)
		return nil
	}
